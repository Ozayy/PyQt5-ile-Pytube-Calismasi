...
"}")
        ...
        self.deneme1.setGeometry(QtCore.QRect(620, 700, 161, 61))
        self.deneme1.setObjectName("deneme1")
        self.table_goback = QtWidgets.QPushButton(self.frame_4)
        self.table_goback.setGeometry(QtCore.QRect(980, 690, 121, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(290, 70, 491, 61))
        font = QtGui.QFont()
...
"}")
        ...
        self.mp4_radio.setGeometry(QtCore.QRect(720, 390, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.mp3_radio.setGeometry(QtCore.QRect(720, 440, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.progressBar.setGeometry(QtCore.QRect(230, 580, 391, 51))
...
"color: rgb(0, 0, 0);")
        ...
        self.comboBox.setGeometry(QtCore.QRect(700, 490, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deneme1.setText(_translate("MainWindow", "See App"))
